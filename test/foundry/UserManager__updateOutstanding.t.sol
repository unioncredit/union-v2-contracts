...
contract TestUserManager__updateOutstanding is TestWrapper {
    ...
    function testUpdateOutstandingLocksEntireCreditline() public {
        ...
        uint256 actualBorrowAmount = creditLimit - fee;
        uint256 actualFee = uToken.calculatingFee(actualBorrowAmount);

        vm.startPrank(MEMBER_4);
        uToken.borrow(actualBorrowAmount);
        uint256 principal = actualBorrowAmount + actualFee;
